<header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-blue-500">
    <nav class="relative max-w-[66rem] w-full md:flex md:items-center md:justify-between md:gap-3 mx-auto px-4 sm:px-6 lg:px-8 py-2">
      <div class="flex items-center justify-between">
        <h1 class="flex items-start flex-none text-white focus:outline-none focus:opacity-80" aria-label="Brand">
            <div class="flex flex-col">
                <div class="font-extrabold text-2xl">
                    Blaue Wolke
                </div>
                <span class="text-sm font-normal">Oldtimer Vermietung</span>
            </div>
        </h1>
